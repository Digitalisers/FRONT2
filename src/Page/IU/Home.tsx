                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <div className="site-branding">
                                <a href="src/Page/IU/Home#"><h1>HEI</h1></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="row">
                            <div className="col-md-6 col-sm-12">
                                <div className="project-title animated fadeInUp">
                                    ...
                                    <a href="https://hei.school/" className="pink-button">Continue Journal</a>
                                </div>
                            </div>
            ...
            <footer className="site-footer container text-center">
                <div className="row">
                    <div className="col-md-12">
                        <div className="main-footer">
                            <ul className="social">
                                <li><a href="src/Page/IU/Home#">Facebook</a></li>
                                <li><a href="src/Page/IU/Home#">Twitter</a></li>
                                <li><a href="src/Page/IU/Home#">Instagram</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div className="row">
                    <div className="col-md-12 copyright">
                        <p>Project 2 &copy; from <a href="src/Page/IU/Home">Digitalisers (git digitalisers eto aveo)</a></p>
                    </div>
                </div>
            </footer>
